...
```bash
   git clone [https://github.com/IvanovvvIhor/Museum-Landing.git](https://github.com/IvanovvvIhor/Museum-Landing.git)
...
* **Fully Responsive Design:** Pixel-perfect implementation for Desktop (1280px), Tablet (640px), and Mobile (>320px) screens without horizontal scrolling.
* **Interactive UI:** Smooth page scrolling, consistent hover animations, and image scaling in the gallery section.
